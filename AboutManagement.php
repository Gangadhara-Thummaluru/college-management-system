...
<html>
    <head>
        ...
        <title>This project is develope by MGG Team</title>
    </head>
    <body>
        <div class="panel panel-default">
			...
			<div class="container">
				<!-- <p style="text-align:center;">See down</p> -->
                        </div><br><br>
                        
                        <h1><strong>Project title: </strong>College Management System</h1>
                        <h1><strong>Made by: </strong>MGG Team</h1>
                        <h1><strong>College: </strong>Rajiv Gandhi university of knowledge Technologies</h1>

...
<body>
    ...
    <div class="img_home_pos">
        <a href="everyone.php"><img src="images/rgukt_logo.jpg" height="90" alt="Raiv Gandhi University of Knowledge Technologies" /></a><span class="header_pos">Raiv Gandhi University of Knowledge Technologies</span>
    </div><br>
		...
		<div class="container_middle">		
			...
			<div class="container_show_post">
				<?php
						...
						elseif($tag=="mess_entry")
							include("Mess_Entry.php");
						elseif($tag=="view_mess")
							include("View_Teachers.php");
